...
final class Definitions {
    ...
    public static function uniqueKeys(): array { return [ [ 'token_hash' ], [ 'jti' ], [ 'id' ] ]; }
    ...
    public static function intColumns(): array { return [ 'id', 'user_id', 'version', 'replaced_by' ]; }
    ...
    public static function piiColumns(): array { return [ 'token_hash', 'ip_hash' ]; }
