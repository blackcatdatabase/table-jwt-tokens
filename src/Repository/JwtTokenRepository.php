...
final class JwtTokenRepository implements RepoContract {
    ...
    public function insert(array $row): void {
        ...
        $tblEsc  = $isMysql ? '`jwt_tokens`' : '"jwt_tokens"';
     ...
     * [ 'token_hash' ] = unikátní klíče (sloupce) pro konflikty,
     * [ 'jti', 'user_id', 'token_hash_algo', 'token_hash_key_version', 'type', 'scopes', 'expires_at', 'last_used_at', 'ip_hash', 'ip_hash_key_version', 'replaced_by', 'revoked', 'meta' ] = které sloupce aktualizovat.
     */
    public function upsert(array $row): void {
        ...
        $keys = [ 'token_hash' ];
        $upd  = [ 'jti', 'user_id', 'token_hash_algo', 'token_hash_key_version', 'type', 'scopes', 'expires_at', 'last_used_at', 'ip_hash', 'ip_hash_key_version', 'replaced_by', 'revoked', 'meta' ];
