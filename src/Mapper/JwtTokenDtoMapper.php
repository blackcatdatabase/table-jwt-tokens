...
namespace BlackCat\Database\Packages\JwtTokens\Mapper;
...
/**
 * Bidirectional mapper between DB rows and DTO JwtTokenDto:
...
final class JwtTokenDtoMapper
{
    ...
    /** @var string[] */
    private const INT_COLS    = [ 'id', 'user_id', 'version', 'replaced_by' ];
    /** @var string[] */
    private const FLOAT_COLS  = [];
    /** @var string[] */
    private const JSON_COLS   = [ 'meta' ];
    /** @var string[] */
    private const DATE_COLS   = [ 'created_at', 'expires_at', 'last_used_at' ];
    /** @var string[] */
    private const BIN_COLS    = [ 'token_hash', 'ip_hash' ];
     ...
     * @return JwtTokenDto
     */
    public static function fromRow(array $row): JwtTokenDto
    {
        /** @var JwtTokenDto */
    ...
    public static function fromRowOrNull(?array $row): ?JwtTokenDto
    {
     ...
     *
     * @param JwtTokenDto   $dto
     * @param string[]|null   $onlyProps  optional whitelist of DTO properties to serialize
     * @return array<string,mixed>
     */
    public static function toRow(JwtTokenDto $dto, ?array $onlyProps = null): array
    {
    ...
    public static function toRowNonNull(JwtTokenDto $dto, ?array $onlyProps = null): array
    {
     ...
     * @return array<string,mixed>
     */
    public static function diff(JwtTokenDto $dto, array $original, array $ignore = [], bool $coerce = true): array
    {
        $now = self::toRow($dto);
     ...
     * @return array<int,JwtTokenDto>
     */
    public static function hydrateList(array $rows): array
    {
        /** @var array<int,JwtTokenDto> */
    ...
    /** @return array<string,mixed> */
    public static function toSafeArray(JwtTokenDto $dto): array
    {
        $row = self::toRow($dto);
     ...
     * @return \Generator<int,JwtTokenDto>
     */
