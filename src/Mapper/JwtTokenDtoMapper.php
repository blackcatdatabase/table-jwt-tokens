...
final class JwtTokenDtoMapper
{
    ...
    /** @var string[] */
    private const INT_COLS    = [ 'id', 'user_id', 'replaced_by' ];
    /** @var string[] */
    ...
    /** @var string[] */
    private const NULLABLE    = [ 'id', 'user_id', 'token_hash_algo', 'token_hash_key_version', 'scopes', 'expires_at', 'last_used_at', 'ip_hash', 'ip_hash_key_version', 'replaced_by', 'meta' ];
