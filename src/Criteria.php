 ...
 * - whitelist filtrů: [ 'id', 'jti', 'user_id', 'token_hash', 'token_hash_algo', 'token_hash_key_version', 'type', 'scopes', 'created_at', 'version', 'expires_at', 'last_used_at', 'ip_hash', 'ip_hash_key_version', 'replaced_by', 'revoked', 'meta' ]
 * - whitelist LIKE:   [ 'jti', 'token_hash_algo', 'token_hash_key_version', 'type', 'scopes', 'ip_hash_key_version' ]
 * Podporované tvary:
...
final class Criteria {
    ...
    public function toSql(bool $viewMode = false): array {
        ...
        $allowed = array_fill_keys([ 'id', 'jti', 'user_id', 'token_hash', 'token_hash_algo', 'token_hash_key_version', 'type', 'scopes', 'created_at', 'version', 'expires_at', 'last_used_at', 'ip_hash', 'ip_hash_key_version', 'replaced_by', 'revoked', 'meta' ], true);
        ...
        $order = null;
        if ($this->sort) {
            $safeCols = array_fill_keys([ 'id', 'jti', 'user_id', 'token_hash', 'token_hash_algo', 'token_hash_key_version', 'type', 'scopes', 'created_at', 'version', 'expires_at', 'last_used_at', 'ip_hash', 'ip_hash_key_version', 'replaced_by', 'revoked', 'meta' ], true);
            $parts = [];
