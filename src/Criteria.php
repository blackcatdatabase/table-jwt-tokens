...
final class Criteria extends BaseCriteria
{
    ...
    {
        $x = [ 'id', 'jti', 'user_id', 'token_hash_algo', 'token_hash_key_version', 'type', 'scopes', 'created_at', 'version', 'expires_at', 'last_used_at', 'ip_hash_key_version', 'replaced_by', 'revoked' ];
