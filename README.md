...
> Lineage: 2 outbound / 1 inbound · ✅ No engine drift detected · Index coverage: ready · PII flags: 7 · Changelog: fresh (18 d)
...
| Pkg folder | [packages\jwt-tokens](https://github.com/blackcatacademy/blackcat-database/blob/main/packages\jwt-tokens) | Repo location |
...
pwsh -NoLogo -NoProfile -File scripts/schema-tools/Migrate-DryRun.ps1 -Package jwt-tokens -Apply
